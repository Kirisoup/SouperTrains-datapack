...
execute positioned ~ ~ ~-2.05 run execute if entity @s[tag=pushing_1] run data modify entity @e[tag=push_2, distance=..1, limit=1] Motion[2] set value -0.1d
...
execute positioned ~ ~ ~2.05 run execute if entity @s[tag=pushing_2] run data modify entity @e[tag=push_1, distance=..1, limit=1] Motion[2] set value 0.1d
...
execute positioned ~0.5 ~-0.5 ~1.5 run execute unless entity @e[tag=tr-col-2, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-2, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-2, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
execute positioned ~0.5 ~-0.5 ~2.5 run execute unless entity @e[tag=tr-col-3, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-3, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-3, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
...
execute positioned ~-0.5 ~-0.5 ~1.5 run execute unless entity @e[tag=tr-col-5, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-5, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-5, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
execute positioned ~-0.5 ~-0.5 ~2.5 run execute unless entity @e[tag=tr-col-6, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-6, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-6, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
...
execute positioned ~0.5 ~-0.5 ~-1.5 run execute unless entity @e[tag=tr-col-8, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-8, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-8, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
execute positioned ~0.5 ~-0.5 ~-2.5 run execute unless entity @e[tag=tr-col-9, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-9, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-9, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
...
execute positioned ~-0.5 ~-0.5 ~-1.5 run execute unless entity @e[tag=tr-col-11, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-11, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-11, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~
execute positioned ~-0.5 ~-0.5 ~-2.5 run execute unless entity @e[tag=tr-col-12, tag=tr-col-b, distance=0] if entity @e[tag=tr-col-12, tag=tr-col-b, distance=..1] run tp @e[tag=tr-col-12, tag=tr-col-b, distance=..1, limit=1] ~ ~ ~